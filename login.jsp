...
<link rel="stylsheet" type="text/css" href="css/font-awesome.css"></link>
</head>
<style>
<body>
...
<input id="pass" type="password" class="input" data-type="password"></div><div class="group">
...
<label for="pass" class="label">Password</label>
 <input id="pass" type="password" class="input" data-type="password"></div>
<div class="group">
...
<label for="check"><span class="icon"></span> Keep me Signed in</label>
			...
			<div class="sign-up-htm">
				...
				<div class="hr"></div>
				<div class="foot-lnk">
					<a><label for="tab-1">Already Member?</label>l</a>
				</div>
			</div>
		</div>
	</div>
